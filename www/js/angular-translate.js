...
var e= [];
             ...
             window.localStorage.setItem('idiomasOption',  JSON.stringify(e)); 
          ...
          if(window.localStorage.getItem('idiomaEV')){
            useLanguage(window.localStorage.getItem('idiomaEV'));
          }
          else{useLanguage('es');}
